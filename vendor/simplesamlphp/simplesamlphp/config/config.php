...
$config['technicalcontact_name'] = "Kumaresan";
$config['technicalcontact_email'] = "kumaresan@yourdomain.com";

// Change these for your installation.
$config['secretsalt'] = 'testsalt';
...
$config['tempdir'] = '/Applications/Mamp/htdocs/tmp';